...
/**
 * ShopTypeController is a controller for managing shop types.
 * It handles creating, retrieving, updating, and deleting shop types.
 *
...
@RequestMapping("/api/v1/shop-types")
